class Background extends MoveableObject {
    ...
    setPropertiesByLayer(layer) {
        switch (layer) {
            case 1:
                this.loadImage("graphics/5_background/layers/1_first_layer/full.png");
                this.width = 720;
                this.height = 320;
                this.y = 480 - this.height;
                break;
            case 2:
                this.loadImage("graphics/5_background/layers/2_second_layer/full.png");
                this.width = 720;
                this.height = 380;
                this.y = 430 - this.height;
                break;
            case 3:
                this.loadImage("graphics/5_background/layers/3_third_layer/full.png");
                this.width = 720;
                this.height = 420;
