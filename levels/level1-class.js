...
class LevelInitializer {
    ...
    generateBottleArray() {
        bottles = [
            ...
            new Bottle(650, "assets/img/6_salsa_bottle/1_salsa_bottle_on_ground.png", 30),
            new Bottle(800, "assets/img/6_salsa_bottle/2_salsa_bottle_on_ground.png", 20),
            new Bottle(850, "assets/img/6_salsa_bottle/1_salsa_bottle_on_ground.png", 30),
